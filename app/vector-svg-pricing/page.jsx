        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <header className="mb-10 md:mb-12">
            ...
            <p className="mt-4 max-w-3xl text-sm md:text-base text-slate-600">
              Pick a starting plan below. If your artwork needs cleanup, color separation, or extra detailing, request a quote and we will review first.
            </p>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-6 max-w-md">
                <div className="space-y-5">
                  ...
                  <FeatureItem
                    ...
                    text="Color edits available for most vector formats (AI, SVG, EPS, etc.)."
                  />
                  <FeatureItem
                    iconBadge="QC"
                    label="Quality checks"
                    text="Clean paths, proper scaling, and print-ready quality at final size."
                  />
                  <FeatureItem
                    iconBadge="OK"
