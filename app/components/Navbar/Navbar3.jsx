    ...
    const navLinks = [
        {
            ...
            sub: [
                ...
                { label: "Hats & Caps Digitizing", href: "/hat-embroidery" },
                { label: "Jacket Back Digitizing", href: "/jacket-back-embroidery" },
                { label: "Pets and Portraits Digitizing", href: "/pet-portrait-embroidery" },
                { label: "Cars and Trucks Digitizing", href: "/vehicle-embroidery" },
                { label: "Appliqué Digitizing", href: "/applique-embroidery" },
            ],
        ...
        },
        {
            ...
            href: "/svg",
            sub: [
                { label: "One Color SVG", href: "#" },
                { label: "Full Color SVG", href: "#" },
                { label: "Cricut & Silhouette", href: "#" },
                { label: "Line Art and Illustration", href: "#" },
            ],
        },
        {
            label: "Custom vector",
            hasDropdown: true,
            dropdownHeading: "PRINT - READY FILES",
            href: "/custom-vector",
            sub: [
                { label: "Image to Vector", href: "#" },
                { label: "Color Separation", href: "#" },
                { label: "DTF Print Files", href: "#" },
                { label: "Screen Print Files", href: "#" },
            ],
        },
        {
            ...
            sub: [
                ...
                { label: "Plasma Cut Files", href: "#" },
            ],
        },
        {
            label: "Design Library",
            hasDropdown: true,
            dropdownHeading: "BROWSE DESIGNS",
            href: "/design",
            sub: [
                { label: "Free Designs", href: "/design?access=free" },
                { label: "Premium Designs", href: "/design?access=premium" },
                { label: "New Arrivals", href: "/design?sort=newest" },
                { label: "Bundles", href: "/design" },
            ],
        },
