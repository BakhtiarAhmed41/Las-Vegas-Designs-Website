...
/**
 * Pet Portrait Embroidery Gallery - Horizontal Carousel
 * Stitch-out samples from assets/images/pets/pets emb/stich
 */
export default function PetPortraitEmbroideryGallery() {
    ...
    const projects = [
        {
            id: 1,
            image: "/assets/images/pets/pets emb/stich/Chihuahua portrait embroidery on cotton fleece sweatshirt.png",
            title: "Chihuahua portrait embroidery",
            description: "On cotton fleece sweatshirt",
            alt: "Chihuahua portrait embroidery on cotton fleece sweatshirt",
        },
        {
            id: 2,
            image: "/assets/images/pets/pets emb/stich/Custom pet portrait embroidery on fleece hoodies and sweatshirts.png",
            title: "Custom pet portrait embroidery",
            description: "On fleece hoodies and sweatshirts",
            alt: "Custom pet portrait embroidery on fleece hoodies and sweatshirts",
        },
        {
            id: 3,
            image: "/assets/images/pets/pets emb/stich/Dog portrait embroidery stitched on fleece sweatshirt.png",
            title: "Dog portrait embroidery",
            description: "Stitched on fleece sweatshirt",
            alt: "Dog portrait embroidery stitched on fleece sweatshirt",
        },
        {
            id: 4,
            image: "/assets/images/pets/pets emb/stich/English Bulldog portrait embroidery on cotton fleece sweatshirt.png",
            title: "English Bulldog portrait",
            description: "On cotton fleece sweatshirt",
            alt: "English Bulldog portrait embroidery on cotton fleece sweatshirt",
        },
        {
            id: 5,
            ...
            description: "On fleece sweatshirt",
            alt: "Labrador Retriever embroidered portrait on fleece sweatshirt",
        },
        {
            id: 6,
            image: "/assets/images/pets/pets emb/stich/pet embroidery logo digitizing sewout (10).png",
            title: "Pet embroidery digitizing sewout",
            description: "Pet portrait stitch out",
            alt: "Pet embroidery logo digitizing sewout",
        },
        {
            id: 7,
            image: "/assets/images/pets/pets emb/stich/pet embroidery logo digitizing sewout (8).png",
            title: "Pet embroidery sewout sample",
            description: "Pet portrait stitch out",
            alt: "Pet embroidery logo digitizing sewout",
        },
        {
            id: 8,
            image: "/assets/images/pets/pets emb/stich/pet embroidery logo digitizing sewout (9).png",
            title: "Pet embroidery sewout sample",
            description: "Pet portrait stitch out",
            alt: "Pet embroidery logo digitizing sewout",
        },
        {
            ...
            title: "Realistic cat portrait",
            description: "On cotton fleece hoodie",
            alt: "Realistic cat portrait embroidery on cotton fleece hoodie",
        },
    ];
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
                <ScrollAnimation animation="fadeInUp" delay={0.1}>
                    <div className="text-center mb-8 md:mb-12">
                        ...
                        <h2 className="text-[20px] sm:text-[29px] md:text-[41px] font-bold text-gray-800 mb-4 text-shadow-sm">
                            Pet & Portrait Stitch Out Samples
                        </h2>
                        <p className="text-[#6b7280] text-sm sm:text-base leading-relaxed max-w-3xl mx-auto font-medium text-shadow-sm">
                            Real stitch outs of pet and portrait embroidery on fleece, sweatshirts, and hoodies—showing clarity and detail.
                        </p>
                    </div>
                </ScrollAnimation>
                ...
                <ScrollAnimation animation="fadeInUp" delay={0.2}>
                    <div
                        ...
                        role="region"
                        aria-label="Pet portrait stitch out samples carousel"
                    >
