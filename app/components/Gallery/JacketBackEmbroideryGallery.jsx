...
/**
 * Jacket Back Embroidery Gallery - Horizontal Carousel
 * Stitch-out samples from assets/images/jacket back/stitch
 */
export default function JacketBackEmbroideryGallery() {
    ...
    const projects = [
        {
            id: 1,
            image: "/assets/images/jacket back/stitch/Alabama \u201CCinderella Baby\u201D embroidery stitched on velvet fabric.png",
            title: "Alabama Cinderella Baby",
            description: "Embroidery on velvet fabric",
            alt: "Alabama Cinderella Baby embroidery stitched on velvet fabric",
        },
        {
            id: 2,
            image: "/assets/images/jacket back/stitch/Dodge Ram diesel stitched-out truck on jacket fabric.png",
            title: "Dodge Ram diesel truck",
            description: "Stitched on jacket fabric",
            alt: "Dodge Ram diesel stitched-out truck on jacket fabric",
        },
        {
            id: 3,
            image: "/assets/images/jacket back/stitch/Eastern Star stitched-out emblem on quilted fabric.png",
            title: "Eastern Star emblem",
            description: "Stitched on quilted fabric",
            alt: "Eastern Star stitched-out emblem on quilted fabric",
        },
        {
            id: 4,
            image: "/assets/images/jacket back/stitch/Masonic Square & Compasses stitched out on fleece hoodie.png",
            title: "Masonic Square & Compasses",
            description: "Stitched on fleece hoodie",
            alt: "Masonic Square & Compasses stitched out on fleece hoodie",
        },
        {
            id: 5,
            image: "/assets/images/jacket back/stitch/MG B classic car Embroidery stitched.png",
            title: "MG B classic car",
            description: "Classic car embroidery",
            alt: "MG B classic car Embroidery stitched",
        },
        {
            id: 6,
            image: "/assets/images/jacket back/stitch/Royal Arch Masons stitched-out embroidery on varsity jacket fabric.png",
            title: "Royal Arch Masons",
            description: "Embroidery on varsity jacket fabric",
            alt: "Royal Arch Masons stitched-out embroidery on varsity jacket fabric",
        },
        {
            id: 7,
            image: "/assets/images/jacket back/stitch/Shelby GT350 car stitched-out embroidery on heather gray knit fabric.png",
            title: "Shelby GT350 car",
            description: "Stitched on heather gray knit",
            alt: "Shelby GT350 car stitched-out embroidery on heather gray knit fabric",
        },
        {
            id: 8,
            image: "/assets/images/jacket back/stitch/Sou\u2019West Glass & Aluminum stitched out on shirt.png",
            title: "Sou'West Glass & Aluminum",
            description: "Stitched out on shirt",
            alt: "Sou'West Glass & Aluminum stitched out on shirt",
        },
    ];
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
                <ScrollAnimation animation="fadeInUp" delay={0.1}>
                    <div className="text-center mb-8 md:mb-12">
                        ...
                        <h2 className="text-[20px] sm:text-[29px] md:text-[41px] font-bold text-gray-800 mb-4 text-shadow-sm">
                            Jacket Back Stitch Out Samples
                        </h2>
                        <p className="text-[#6b7280] text-sm sm:text-base leading-relaxed max-w-3xl mx-auto font-medium text-shadow-sm">
                            Real stitch outs of jacket back and large-format designs on hoodies, varsity fabric, and knit—showing clarity, density balance, and clean edges.
                        </p>
                    </div>
                </ScrollAnimation>
                ...
                <ScrollAnimation animation="fadeInUp" delay={0.2}>
                    <div
                        ...
                        role="region"
                        aria-label="Jacket back stitch out samples carousel"
                    >
