...
function DigitizingPortfolio() {
  ...
  const projects = digitizingSlider.map((item, idx) => ({
    id: item.id,
    image: `${dir}${item.src}`,
    title: `Digitizing Sample ${String(idx + 1).padStart(2, "0")}`,
    description: "Preview of a digitized embroidery file",
    alt: item.src,
  }));
  ...
  return (
    <section
      id="digitizing-portfolio"
      className="bg-linear-to-b from-white to-gray-50 py-12 md:py-16 lg:py-20 scroll-mt-20"
    >
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <ScrollAnimation animation="fadeInUp" delay={0.1}>
          <div className="text-center mb-8 md:mb-12">
            <div className="mb-4 flex justify-center">
              <ServiceLabel text="DIGITIZING PREVIEW GALLERY" />
            </div>
            ...
            <p className="text-[#6b7280] text-sm sm:text-base leading-relaxed max-w-3xl mx-auto font-medium text-shadow-sm">
              These digitized files are the exclusive property of Las Vegas
              Designs USA and their respective clients. Images are for viewing
              purposes only. Please do not use without permission.
            </p>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animation="fadeInUp" delay={0.2}>
          <div
            ...
            role="region"
            aria-label="Digitizing portfolio carousel"
          >
                  ...
                  return (
                    <article
                      ...
                      style={{
                        ...
                        zIndex,
                        transition:
                          "all 3000ms cubic-bezier(0.25, 0.46, 0.45, 0.94)",
                      ...
                      aria-label={`${project.title} - ${
                        isCenter ? "Currently viewing" : "Click to view"
                      }`}
                    >
                      <div
                        ...
                        style={{
                          ...
                          transition:
                            "box-shadow 3000ms cubic-bezier(0.25, 0.46, 0.45, 0.94)",
                        }}
                      >
